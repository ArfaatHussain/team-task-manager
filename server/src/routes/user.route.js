...
import { getUserProfile, updateUserProfile, getAllUnassignedUsers, getTeams, getTasks } from "../controllers/user.controller.js";
...
userRouter.route("/getTasks/:userId").get(verifyUser, getTasks)
